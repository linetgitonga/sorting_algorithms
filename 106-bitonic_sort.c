...
#include <stdio.h>
/**
 * swap -  Function to change two values in ascending or descending order
 * @arr: array
 * @item1: item one
 * @item2: item second
...
/**
 * merge - Function to  sort bitonic sequences recursively in both orders
 * @arr: the array
 * @low: first element
...
/**
 * bitonicsort- Function bitonic sort algorithm implementation
 * @arr: array
 * @low: first element
